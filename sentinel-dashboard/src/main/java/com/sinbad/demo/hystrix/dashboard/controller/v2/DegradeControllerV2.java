 ...
 */
package com.sinbad.demo.hystrix.dashboard.controller.v2;
...
import com.sinbad.demo.hystrix.dashboard.repository.rule.InMemDegradeRuleStore;
...
public class DegradeControllerV2 {
	...
	private DynamicDataSourceProvider<List<DegradeRuleEntity>> ruleProvider;
	@Autowired
	//@Qualifier("flowRuleDefaultPublisher")
	@Qualifier("degradeRuleZookeeperPublisher")
	private DynamicDatasourcePublisher<List<DegradeRuleEntity>> rulePublisher;
	...
	private boolean publishRules(String appName) {
